...
# Set up the database
echo "CREATE DATABASE IF NOT EXISTS towing" | mysql
echo "CREATE USER 'towing'@'localhost' IDENTIFIED BY ''" | mysql
echo "GRANT ALL PRIVILEGES ON towing.* TO 'towing'@'localhost' IDENTIFIED BY ''" | mysql
